...
CREATE TABLE IF NOT EXISTS courses (
  ...
  price_vivo_old DECIMAL(10, 2) NULL COMMENT 'Precio normal en soles (tachado si hay oferta)',
  price_vivo_usd DECIMAL(10, 2),
  price_vivo_usd_old DECIMAL(10, 2) NULL COMMENT 'Precio normal en USD (tachado si hay oferta)',
  price_grabado DECIMAL(10, 2),
  price_grabado_old DECIMAL(10, 2) NULL COMMENT 'Precio normal en soles (tachado si hay oferta)',
  price_grabado_usd DECIMAL(10, 2),
  price_grabado_usd_old DECIMAL(10, 2) NULL COMMENT 'Precio normal en USD (tachado si hay oferta)',
  duration VARCHAR(50),
  ...
  landing_page_type ENUM('automated', 'custom') DEFAULT 'automated' COMMENT 'Si la landing del curso es la genérica (/cursos/slug) o una página personalizada',
  custom_landing_url VARCHAR(255) NULL COMMENT 'Ruta interna de la landing personalizada (ej: /curso-desarrolla-con-claude), solo aplica si landing_page_type = custom',
  whatsapp_message VARCHAR(500) NULL COMMENT 'Mensaje personalizado del botón de WhatsApp de la landing. Admite {curso}. Vacío = mensaje automático',
  instructor_id INT,
