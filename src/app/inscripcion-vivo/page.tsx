      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Tu inscripción al curso <strong>{curso?.title}</strong> ha sido confirmada.
          </p>
          <div style={{
            backgroundColor: colors.gray[50],
            padding: spacing.lg,
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span>Clases en vivo + certificado digital</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.xs }}>
                  <div>✓ {curso?.hours || '40 horas'} de contenido en vivo</div>
                  <div>✓ {curso?.modules?.length || 8} módulos especializados</div>
                  <div>✓ Interacción con el instructor</div>
...
export default function InscripcionVivoPage() {
  return (
    <Suspense fallback={
      <div style={{
        minHeight: '100vh',
