...
})(window,document,'script','dataLayer','GTM-NCTGSQCC');`
          }}
        />
...
fbq('init', '2264653411019812');
fbq('track', 'PageView');`
          }}
        />
        <noscript>
          <img height="1" width="1" style={{display: 'none'}}
            src="https://www.facebook.com/tr?id=2264653411019812&ev=PageView&noscript=1"
          />
        </noscript>
        {/* End Meta Pixel Code */}
        ...
        <meta name="apple-mobile-web-app-title" content="SmartChatix" />
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NCTGSQCC"
            height="0"
            width="0"
